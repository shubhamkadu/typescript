...
console.log("someElement1", someElement1.value); // this is incorrect way to solve it
...
//**ADDING A LISTENER */
var someElement3 = document.querySelector("foo");
someElement3.addEventListener('blur', function (event) {
...
someElement3.addEventListener('blur', function (event) {
    var target = event.target; // we know that we are working with html input element that why we write there HTMLInputElement
